#+TITLE:  Matlab与C混合编程API之mxCreateDoubleMatrix
#+AUTHOR:    zcl.space
#+EMAIL:     emacsun@163.com
#+DATE:
#+DESCRIPTION:  mxCreateDoubleMatrix创建二维双精度浮点数组
#+KEYWORDS: matlab communication simulation C
#+CATEGORIES: communication
#+SETUPFILE: ~/.emacs.d/org-templates/matlab-level2.org
#+HTML_HEAD_EXTRA: <a id="pdf"  href="./matlabmxCreateDoulbeMatrix.pdf"><img src="../../img/assets/pdf.png"></a>

* 引言
  <2015-11-12 Thu 22:42>

通过[[file:matlabandc.org][matlab与C混合编程之基本原理]], 我们知道:在matlab与C的混合编程中，桥梁函数 =mexFunction= 发挥着至关重要的作用。在这个桥梁函数中，通过调用matlab提供的API可以很方便的实现matlab和C之间的混合编程。本节介绍一个API，名称为： =mxCreateDoubleMatrix= 。该API的作用是创建二维的双精度浮点数组。

* 调用语法
  <2015-11-13 Fri 05:57>
...
* 输入输出参数
  <2015-11-13 Fri 05:58>

输入参数如表[[tab:20151113inputoutput]]所示
#+CAPTION:  mxCreateDoubleMatrix输入输出参数表
#+NAME: tab:20151113inputoutput
|---------------+------+------------------+---------------|
| 参数          | 性质 | 描述             | 类型          |
|---------------+------+------------------+---------------|
| =m=           | 输入 | 矩阵行数         | =mwSize=      |
