...
#+HTML_HEAD_EXTRA: <a id="pdf" href="continuity.pdf"><img src="../../img/assets/pdf.png"></a>
#+LaTeX_CLASS: article
...
$$
The map  $f$ is said to be *uniformly continuous*
iff
$$
...
#+end_proof
  ...
  The map $f$ is said to be *Lipschitz* iff there is
