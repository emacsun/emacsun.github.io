...
#+HTML_HEAD_EXTRA: <a id="pdf"  href="./one-dimension-random-walk.pdf"><img src="../../img/assets/pdf.png"></a>
#+LaTeX_CLASS: cn-article
#+OPTIONS: toc:nil

在[[file:definition-of-stochastic-process.org][随机过程的定义]] 一节中，我们定义了基于概率空间\((\Omega,\mathcal{F},P)\)的随机过程\(\{\xi(\omega,t),t\in T\}\)。针对 参数\(T\)和\(\xi_{t}(\omega)\)的状态取值是连续的或者离散的，我们有四种随机过程。
...
#+NAME: fig:20170418one-way-random-walk
#+ATTR_LATEX: :width 0.6\textwidth :align center
[[../../img/math_stochastic/20170418stochastic-one-way-random-walk.png]]
...
又设质点每次游动与该质点所处的位置无关，当\(i\neq k\)时，\(\xi_{i},\xi_{k}\)是相互统计独立的随机变量。图[[fig:20170418one-way-random-walk]] 给出了\(\eta_{n}\)的样本函数。
