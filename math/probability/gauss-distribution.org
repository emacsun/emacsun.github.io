...
#+HTML_HEAD_EXTRA: <a id="pdf" href="gauss-distribution.pdf"><img src="../../img/assets/pdf.png"></a>

[[file:afcp-normal-distribution-history.org][八卦一下]] ，高斯随机变量不是高斯发现的，是一个叫亚伯拉罕\(\cdot\)棣莫弗的数学家发现的。无论哪个发现的高斯随机变量，都不影响高斯随机变量在概率论中的重要地位。

* 定义
  [2017-06-10 Sat 08:22]
...
#+NAME: fig:20170610figure5dot5gaussian
#+ATTR_LATEX: :width 0.6\textwidth :align center
[[../../img/math_probability/20170610figure5dot5gaussian.png]]
...
现在，二项分布有两种可能的近似：当\(n\)较大\(p\)较小时，[[file:poisson-distribution.org][泊松分布]] 是一个很好的近似；另外，可以证明，当\(np(1-p)\)较大时，正态分布近似的效果很好。一般情况下，当\(np(1-p) \geq 10\)时，正态近似就非常好。
