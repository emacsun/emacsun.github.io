...
#+HTML_HEAD_EXTRA: <a id="pdf"  href="./PRMLch2dot4-bayesian-inference-for-gaussian.pdf"><img src="../../img/assets/pdf.png"></a>
#+LaTeX_CLASS: cn-article

* 简介
  [2017-06-17 Sat 11:24]
...
我们[[file:PRMLch2dot3-maximum-likelihood-for-gaussian.org][之前]] 看到了过高斯分布的均值可以采用迭代的方式计算得出。实际上，贝叶斯估计也可以采用这种方式。
\begin{equation}
\label{eq:6}
