...
#+HTML_HEAD_EXTRA: <a id="pdf"  href="./PRMLch2dot3-maximum-likelihood-for-gaussian.pdf"><img src="../../img/assets/pdf.png"></a>
#+LaTeX_CLASS: cn-article

* 原理
  [2017-06-15 Thu 22:40]
...
\end{equation}
式 (\ref{eq:8}) 的结果可以用图[[fig:20170616figure2dot10]]来表示。
#+CAPTION:  Robbins-Monro算法
#+ATTR_HTML:  :width 400 :align center
#+NAME: fig:20170616figure2dot10
#+ATTR_LATEX: :width 0.6\textwidth :align center
[[../../img/computer_prml/20170616figure2dot10.png]]
...
\end{equation}
另外，不失一般性，我们认为\(f(\theta) > 0, \theta > \theta^{*}\), 且\( f(\theta ) < 0, \theta < \theta^{*} \), 就像图[[fig:20170616figure2dot10]]所示的那样。Robbins=Monro过程定义了估计\(\theta^{*}\)的一个递推式：
\begin{equation}
\label{eq:10}
