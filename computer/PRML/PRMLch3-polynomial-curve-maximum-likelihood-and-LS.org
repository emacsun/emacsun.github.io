...
#+HTML_HEAD_EXTRA: <a id="pdf"  href="./PRMLch3-polynomial-curve-maximum-likelihood-and-LS.pdf"><img src="../../img/assets/pdf.png"></a>
#+LaTeX_CLASS: cn-article

[[file:PRMLch1dot1-polynomial-curve.org][之前]]，我们讨论过关于曲线拟合的一些概念，提到了均方误差函数和[[file:PRMLch1dot1-polynomial-curve-probability-revist.org][贝叶斯估计]] , 并在一篇[[file:PRMLch1dot1-polynomial-curve-matlab.org][博文]]中介绍了 matlab 实现。今天，我们讨论通过最小二乘法对最大斯然估计进行深入的挖掘。

* 问题模型
  [2017-08-05 Sat 13:44]
...
\end{equation}
* 问题分析：最大化斯然函数和最小化平方和误差函数的等效性
  [2017-08-05 Sat 13:50]
